...
Original file is located at
    https://colab.research.google.com/drive/1q3AHQyKc0PoZn1EU5Xy62eMsEJDmMdUZ
"""
...
feedback_question_1 = 13

feedback_question_2 = """
A stumbling block I faced was that the other methods needed to call inferac3 and 
at first that just wouldn't work for me which was super difficult but after that 
worked it was nice to simply use older algorithms on new ones.
"""

feedback_question_3 = """
I really really liked how the functions communicated with each other, each function
taking on a level of abstraction that brought us closer to our answer. I found
the kind of logic used in solving this assignment very clever and akin to a
"gravity" assembly line where solutions are half done but by the time we get to 
the ground floor our solution's fully implemented and ready to be shipped to the 
world :) 
"""