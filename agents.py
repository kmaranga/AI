...
Original file is located at
    https://colab.research.google.com/drive/1mEmiVLw-lM47IgPHx2QJgCk4H0p7JLqy
"""
...
feedback_question_2 = """
Debugging was a bit of a challenge since the core methods depended on other methods 
that needed to be working seamlessly. Naomi's computer was also unable to run the 
GUI but we were able to do it together on one computer. 
"""

feedback_question_3 = """
We really enjoyed working on this homework due to its problem solving aspects
and it was actually pretty neat running iterations on the GUI and coming up with 
optimal policies
"""